...
/****************  Evaluated Addition & Multiplication.  ****************/
 ...
 void evaluate_add_ex(__cit* sum, __cit* c1, __cit* c2, __pubkey_set* pubkey); //expand

 void evaluate_add(__cit* sum, __cit* c1, __cit* c2, mpz_t x0);//不带密文扩展的同态加密法操作

 void evaluate_mul_ex(__cit* product, __cit* c1, __cit* c2, __pubkey_set* pubkey); //expand

 void evaluate_mul(__cit* product, __cit* c1, __cit* c2, mpz_t x0);//不带密文扩展的同态乘法操作
